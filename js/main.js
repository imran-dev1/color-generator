...
document.getElementById("copy-btn").addEventListener("mouseover", function () {
   ...
   copyBtn.innerHTML = `<ion-icon name="copy-outline" class="fs-5"></ion-icon>Copy to clipboard`;
});
document.getElementById("copy-btn").addEventListener("mouseout", function () {
   const copyBtn = document.getElementById("copy-btn");
   copyBtn.innerHTML = `
   <ion-icon name="copy-outline" class="fs-5"></ion-icon>Copy`;
});
let div = null;
document.getElementById("copy-btn").addEventListener("click", function () {
   ...
   if (inputField.value != "") {
      ...
      alert("Please generate Your Color First!");
   }
});
